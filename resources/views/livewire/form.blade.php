...
<div>
    <div class="overflow-auto lg:overflow-visible space-y-6">
      ...
      <div class="bg-white rounded-md py-10 px-4 mb-4 shadow-md">
        <input class="rounded-lg border-none w-full" type="text" id="" name="" placeholder="Dinner for today">
        <hr>
      </div>
      ...
      <div class="bg-white rounded-md p-4 mb-4 shadow-md">
        ...
        <input class="rounded-lg border-none border-opacity-0 mt-3 w-full" type="text" id="" name="" placeholder="How was it?">
      </div>
